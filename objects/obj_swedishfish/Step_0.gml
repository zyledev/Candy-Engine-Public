...
if (sprite_index == spr_swed_chargestart && animation_end())
{
...
if (bombreset > 0)
	bombreset--;
if (!obj_player.bushdetection && ((obj_player.x > (x - 400) && obj_player.x < (x + 400)) && (y <= (obj_player.y + 60) && y >= (obj_player.y - 60))) && state == baddiestates.walk && bombreset == 0)
{
